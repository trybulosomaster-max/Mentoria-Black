...
export const semantic = Object.freeze({
  ...
  text: Object.freeze({ primary: themeTokens.dark.text.primary, secondary: themeTokens.dark.text.secondary, subtle: themeTokens.dark.text.secondary, inverse: themeTokens.dark.text.inverse, accent: themeTokens.dark.brand.accent }),
  ...
  action: Object.freeze({ primary: themeTokens.dark.brand.accent, primaryPressed: primitives.color.gold[700], secondary: themeTokens.dark.background.surfaceMuted, disabled: themeTokens.dark.border.default }),
...
export const textStyles = Object.freeze({
  display: textStyle({ fontFamily: type.family.uiBold, fontSize: type.size.display, lineHeight: type.lineHeight.display, letterSpacing: type.letterSpacing.tight }),
  ...
  section: textStyle({ fontFamily: type.family.uiBold, fontSize: type.size.section, lineHeight: type.lineHeight.section }),
  body: textStyle({ fontFamily: type.family.uiRegular, fontSize: type.size.body, lineHeight: type.lineHeight.body }),
  bodySmall: textStyle({ fontFamily: type.family.uiRegular, fontSize: type.size.bodySmall, lineHeight: type.lineHeight.bodySmall }),
  caption: textStyle({ fontFamily: type.family.uiSemiBold, fontSize: type.size.caption, lineHeight: type.lineHeight.caption }),
  moneyXL: textStyle({ fontFamily: type.family.uiBold, fontSize: type.size.display, lineHeight: type.lineHeight.display, fontVariant: ['tabular-nums'] }),
