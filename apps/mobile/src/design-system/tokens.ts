...
export const componentTokens = Object.freeze({
  ...
  dashboard: Object.freeze({ flowIndicatorSize: 60, chartHeight: 136, chartPadding: 10, chartPointSize: 6, incomeLineWidth: 3, expenseLineWidth: 2 }),
