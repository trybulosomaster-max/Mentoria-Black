...
V67 — PROMPT ESCUDO / CATEGORIAS DINÂMICAS
- Base: V60 FINAL.
...
V67 — PROMPT ESCUDO / CORREÇÃO RAIZ DO GRÁFICO
...
V67 — PROMPT ESCUDO EVOLUÍDO / EVOLUÇÃO DAS RECEITAS
APRENDIZADO NOVO:
...
V67 — PROMPT ESCUDO EVOLUÍDO / CATEGORIA LEGADA EM TODA A UI
NOVO APRENDIZADO:
...
V67 — PROMPT ESCUDO EVOLUÍDO / CONSISTÊNCIA DE INVESTIMENTOS
NOVO APRENDIZADO:
...
- V67 criou uma única fonte `investmentAmount()` para o valor de Investimentos.
- V67 criou `realizedByCategory()` para o realizado por categoria.
