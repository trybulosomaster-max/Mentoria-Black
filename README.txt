...
V68 — PROMPT ESCUDO / CATEGORIAS DINÂMICAS
- Base: V60 FINAL.
...
V68 — PROMPT ESCUDO / CORREÇÃO RAIZ DO GRÁFICO
...
V68 — PROMPT ESCUDO EVOLUÍDO / EVOLUÇÃO DAS RECEITAS
APRENDIZADO NOVO:
...
V68 — PROMPT ESCUDO EVOLUÍDO / CATEGORIA LEGADA EM TODA A UI
NOVO APRENDIZADO:
...
V68 — PROMPT ESCUDO EVOLUÍDO / CONSISTÊNCIA DE INVESTIMENTOS
NOVO APRENDIZADO:
...
- V68 criou uma única fonte `investmentAmount()` para o valor de Investimentos.
- V68 criou `realizedByCategory()` para o realizado por categoria.
...
V68 — PROMPT ESCUDO EVOLUÍDO / EVOLUÇÃO DAS RECEITAS 2
NOVO APRENDIZADO:
...
- V68 usa a mesma coleção de transações do Dashboard.
