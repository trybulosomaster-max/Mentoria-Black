...
- A Dashboard NÃO exibe mais o card “Inteligência Black”.
- A Inteligência Black permanece na aba independente “Saúde Financeira”.
- O resumo da Saúde Financeira, incluindo a análise da Reserva, fica concentrado nessa aba.
- Nenhuma regra de cálculo, lançamento, meta, carteira ou schema do Supabase foi alterada nesta versão.
