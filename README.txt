MENTORIA BLACK — V61 FINAL

STATUS
V61 consolidada a partir da V59 estável, seguindo o Prompt Escudo.

PRINCÍPIO DE CONSOLIDAÇÃO
- Não foi criada uma nova camada V61 sobre a V59.
- As extensões de Reserva e Saúde Financeira foram incorporadas a um único módulo de integração V61.
...
CACHE
- Service Worker: mentoria-black-V61.
...
Toda nova versão deve partir desta V61 limpa/consolidada, ser auditada antes da alteração e incorporar a mudança diretamente à implementação definitiva.
...
V61 — PROMPT ESCUDO
- Base: V60 FINAL.
- Correção consolidada de categoria: “Liberdade Financeira” não é mais usada como rótulo de apresentação; a categoria atual “Investimentos” é a referência.
- A apresentação de categoria deve consultar o cadastro atual em DATA.categories.
- A cor da categoria deve ser obtida do cadastro atual quando disponível.
- Nenhum schema ou dado do Supabase foi alterado.
- Nenhum patch de versão foi adicionado por carregamento externo.
- Mantidos os arquivos oficiais: index.html, sw.js e README.txt.
- Esta versão deve ser validada antes de qualquer nova versão.
