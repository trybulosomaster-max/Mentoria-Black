...
ok(css.includes('justify-content: flex-start;'),'authenticated brand is left aligned');
ok(css.includes('width: 56px;')&&css.includes('height: 56px;'),'desktop badge stays within the approved compact size');
ok(css.includes('width: 46px;')&&css.includes('height: 46px;'),'mobile badge stays within the approved compact size');
ok(css.includes('grid-column: 2;')&&css.includes('justify-content: flex-end !important;'),'desktop actions remain at the right edge');
ok(css.includes('grid-row: 3;'),'mobile actions receive an independent row');
