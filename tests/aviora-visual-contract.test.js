...
test('cache frontend referencia a nova camada visual e o asset oficial',()=>{
 ...
 ok(index.includes('<meta name="aviora-build" content="aviora-v1-structural-b2-smoke2">'));
 ok(index.includes('<link rel="stylesheet" href="assets/aviora-v82.css?v=aviora-v1-structural-b2-smoke2">'));
